...
pub struct StructureCols {
    ...
    pub current_health: __sdk::__query_builder::Col<Structure, f32>,
    pub max_health: __sdk::__query_builder::Col<Structure, f32>,
...
impl __sdk::__query_builder::HasCols for Structure {
    ...
    fn cols(table_name: &'static str) -> Self::Cols {
        StructureCols {
            ...
            current_health: __sdk::__query_builder::Col::new(table_name, "current_health"),
